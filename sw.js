...
*/
const CACHE_NAME = 'ift-amana-shell-v2';
const APP_SHELL = [
  './customer-consignment-app.html',
  './manifest.json',
  './icon-192.png',
  './icon-512.png'
];
...
self.addEventListener('fetch', (event) => {
  ...
  // نتدخّل فقط في ملفات الموقع نفسه (نفس الأصل/Origin).
  // أي طلب خارجي (Firebase, Google Fonts, cdnjs...) نسيبه يمشي طبيعي زي ما كان قبل أي تعديل —
  // التدخّل فيه هو اللي كان بيسبب مشاكل شبيهة بـ CORS / Access-Control ويأثر على اتصال Firebase.
